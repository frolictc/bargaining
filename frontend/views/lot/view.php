...
<div class="lot-view">
    ...
    <p>
    	<?php if (\Yii::$app->user->can('createLot') && $model->seller_id == Yii::$app->user->id): ?>
        ...
        <?php if (\Yii::$app->user->can('buyLot') && $model->getActualStatus() == 1): ?>
        	<?= Html::a('Купить', ['buy', 'id' => $model->id], ['class' => 'btn btn-success']) ?>
        <?php endif; ?>
    </p>
